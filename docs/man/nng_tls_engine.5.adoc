...
xref:nng_tls_engine_fips_mode.3tls.adoc[`nng_tls_engine_fips_mode()`], and
xref:nng_tls_engine_check_pkcs11.3tls.adoc[`nng_tls_engine_check_pkcs11()`]
functions.
...
xref:nng_tls_engine_check_pkcs11.3tls.adoc[nng_tls_engine_check_pkcs11(3tls)],
